...
public interface RobotWorldClient {
    ...
    /*
    SIYAMTHANDA NDZIPHA ---
    Ive added the two methods  below to the RobotWorldClient interface to read and notify the client

    Since this is an interface class , no implementation,
    i did the implementation on the concrete class
    */

    JsonNode readPushedNotification();


// This method is used to notify the client that it has been removed from the server
    JsonNode notifyRemoved();
}
